...
def create_output_placeholders(prompt_dir, output_dir):
    ...
    for filename in os.listdir(prompt_dir):
        if filename.startswith("prompt_") and filename.endswith(".txt"):
            ...
            output_filename = f"output_{base_name}.clj"
...
# Example usage:
prompt_dir = "/home/scriptie/Scriptie/ChatGPT/clojure/prompts"
output_dir = "/home/scriptie/Scriptie/ChatGPT/clojure/output"
